    ...
    <Container>
      <form className={styles.contentContainer} action="">
        ...
        <div className={styles.inputsDateContainer}>
          ...
          <div>
            <div className={styles.inputDateContainer}>
              ...
              <input
                className={`${styles.input} ${styles.inputDate} ${
                  dateDe && styles.inputDateSelected
                }`}
                type="date"
                name="de"
                id="de"
            ...
            <div className={styles.inputDateContainer}>
              ...
              <input
                className={`${styles.input} ${styles.inputDate} ${
                  dateAte && styles.inputDateSelected
                }`}
                type="date"
                name="ate"
                id="ate"
        ...
        <div className={styles.radioContainer}>
          ...
          <div>
            <input
              ...
              name="atividade"
              id="alvara"
              value="Alvará transitório de eventos"
              checked={atividade === "Alvará transitório de eventos"}
              onChange={handleRadioChange}
            />
            <label
              className={`${styles.inputRadio} ${
                atividade === "Alvará transitório de eventos" &&
                styles.inputRadioSelected
              }`}
              htmlFor="alvara"
            >
          ...
          <div>
            <input
              ...
              name="atividade"
              id="acesso"
              value="Acesso do tesouro municipal"
              checked={atividade === "Acesso do tesouro municipal"}
              onChange={handleRadioChange}
            />
            <label
              className={`${styles.inputRadio} ${
                atividade === "Acesso do tesouro municipal" &&
                styles.inputRadioSelected
              }`}
              htmlFor="acesso"
            >
              Acesso do tesouro municipal
            </label>
          </div>
          <div>
            <input
              ...
              name="atividade"
              id="licenciamento"
              value="Licenciamento da vigilância sanitária"
              checked={atividade === "Licenciamento da vigilância sanitária"}
              onChange={handleRadioChange}
            />
            <label
              className={`${styles.inputRadio} ${
                atividade === "Licenciamento da vigilância sanitária" &&
                styles.inputRadioSelected
              }`}
          ...
          <div>
            <input
              ...
              name="atividade"
              id="multas"
              value="Multas de trânsito"
              checked={atividade === "Multas de trânsito"}
              onChange={handleRadioChange}
            />
            <label
              className={`${styles.inputRadio} ${
                atividade === "Multas de trânsito" && styles.inputRadioSelected
              }`}
              htmlFor="multas"
            >
              Multas de trânsito
          ...
          <div>
            <input
              ...
              name="atividade"
              id="rio"
              value="Rio mais fácil negócios"
              checked={atividade === "Rio mais fácil negócios"}
              onChange={handleRadioChange}
            />
            <label
              className={`${styles.inputRadio} ${
                atividade === "Rio mais fácil negócios" &&
                styles.inputRadioSelected
              }`}
              htmlFor="rio"
            >
        ...
        <div className={styles.buttonsContainer}>
          ...
          <Button type="no-outlined" bg="error" props={{ onClick: closeForm }}>
            cancelar
          </Button>
        </div>
      </form>
