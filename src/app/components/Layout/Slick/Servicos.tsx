      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.text}>
            ...
            do quadro societário ou no registro de "Representante" daquele CNPJ;
            Se estiver, a empresa é adicionada ao seu perfil.
          </p>
        </div>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.text}>
            ...
            específicos e com prazos de validade definidos. Basta clicar no nome
            da empresa e seguir as instruções do site.
          </p>
        </div>
      </div>
    </Container>
